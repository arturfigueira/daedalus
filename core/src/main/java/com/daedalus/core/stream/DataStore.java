...
public interface DataStore {
   ...
   * @param data       a map containing the data to be store
   * @return A future that will resolve with the {@link StoreResult}
   */
  Future<StoreResult> store(String identifier, Map<String, Object> data);
   ...
   * @return A future that will resolve with the {@link StoreResult}
   */
  Future<StoreResult> store(Map<String, Object> data);
}
